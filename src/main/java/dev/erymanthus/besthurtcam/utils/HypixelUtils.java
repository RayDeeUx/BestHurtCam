package dev.erymanthus.besthurtcam.utils;
...
public class HypixelUtils {
    ...
    private static final boolean ERY = Minecraft.getMinecraft().getSession().getPlayerID().equalsIgnoreCase("b43d74579da4408ba9fb51239022cec9");
    ...
    public static void checkForSkyblock() {
        if (EssentialAPI.getMinecraftUtil().isHypixel()) {
            ...
            if (scoreboardObj != null) {
                ...
                if (scObjName.contains("SKYBLOCK") || (ERY)) {
                    inSkyblock = true;
                    return;
                }
            }
